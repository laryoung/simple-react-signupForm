...
export const StyledButton = styled(Link)`
  ...
  &:hover {
    ...
    color: ${(props) => (props.textColor ? props.textColor : colors.theme)};
    cursor: pointer;
  }
`;
...
export const StyledFormButton = styled.button`
  ...
  background-color: transparent;
  font-size: 16px;
  border: 2px solid ${(props) => (props.color ? props.color : colors.theme)};
  border-radius: 25px;
  color: ${(props) => (props.textColor ? props.textColor : colors.theme)};
  ...
  &:hover {
    background-color: ${(props) => (props.color ? props.color : colors.theme)};
    color: ${(props) => (props.textColor ? props.textColor : colors.primary)};
    cursor: pointer;
  }
`;
